...
# Status
status: canonical
source: Eclipse-II-P001, Eclipse-II-P023, Eclipse-II-P050, Eclipse-II-P159, Eclipse-II-P185, AA-Kratos-P278, AA-Kratos-P279, AA-Kratos-P281, AA-Kratos-P282, AA-Kratos-P302, AA-Kratos-P303
...
**Nomothete Holariston Polykráton Krator (Nr+Em)**

| Term | Meaning |
|------|---------|
| **Nomothete** | Lawgiver tier (highest power classification) |
| **Holariston** | Complete/whole mastery |
| **Polykráton** | Dominion over multiple forces |
| **Krator** | Practitioner of Krátos |
| **Nr** | Pyrenikon (Nuclear Force) |
| **Em** | Elektromagneton (Electromagnetic Force) |
...
## II. The Three Pillars (Triad of Sovereignty)

**Power = (Lineage) × (Will) × (Vessel)**
...
## III. Horme: The Conqueror's Desire

Godric's Horme has evolved across his existence:

| Era | Horme | Expression |
|-----|-------|------------|
| **I-V** | Survival | Protecting self and territory |
| **V-VI** | Control & Mastery | Perfecting his abilities |
...
## IV. The Sculptor Archetype

Godric exemplifies the **Sculptor** philosophy—one of the [[Part_VI_Character_Applications|Four Kratonic Archetypes]].
...
**Components:**
1. **Internal Fortification (Stereosis)** — Augments musculature and physical power
2. **Internal Neutralization (Exoudeterosis)** — Suffuses cells with will; supercharges defense/regeneration
...
| 2 | 15-50% | Dominance | Standard serious combat; overwhelming physicality |
| 3 | 50-100%+ | The King's Wrath | Existential threats; affects environment |

### Atomic Railgun — Trophy of Intellect
...
## VII. Foundational Kratonic Arts

### The Three Edicts of Personal Coating

| Edict | Greek | Function | Godric's Mastery |
|-------|-------|----------|------------------|
| **Fortification** | Stereosis | Augments body to god-like degree | Undisputed |
| **Neutralization** | Exoudeterosis | Makes cells a defensive weapon | Core of his durability |
| **Penetration** | Diatresis | Ensures actions bypass defenses | Innate to Amplified state |
...
## VIII. The Elektromagneton: The Hidden Half

> *For the complete exploration of this topic, see [[elektromagneton-nature|The Elektromagneton Nature: The Hidden Half of Gojira Power]].*
...
### Passive EM Applications

| Application | Function |
|-------------|----------|
| **Sixth Sense** | Perceives Earth's magnetic fields; perfect navigation |
| **Lightning Rod** | Scales/dorsal fins absorb electrical discharge; immune to bioelectricity |
| **Enhanced Senses** | Detects EM phenomena alongside atomic senses |

### Active EM Applications (Largely Untapped)
...
## X. Position in the Nomothete Quadrivium

The four strongest beings across all power systems form the **Nomothete Quadrivium**:

| Position | Being | System | Classification |
|----------|-------|--------|----------------|
| **The Tangible Intuitive** | Godzilla | Krátos | The Worker |
| **The Intangible Intuitive** | [[Mothra, the Queen of the Monsters\|Mothra]] | Psionics | The Divine |
...
Both dedicate themselves to honing Will (Pillar II) and Vessel (Pillar III). Despite different systems, they recognize fellow sovereigns in discipline and effort.

---

## XI. Post-Xilien State
...
| Source | Content |
|--------|---------|
| Eclipse-II P001 | Krátos System Introduction |
| Eclipse-II P023 | Triad of Sovereignty |
| Eclipse-II P050 | Complete Power System Overview |
| Eclipse-II P159 | Repose Mystery |
| Eclipse-II P185 | Atomic Amplification Kratonic Definition |
| AA-Kratos P278 | Combat Philosophy Profile |
| AA-Kratos P279 | AA Profile Section II |
| AA-Kratos P281 | Primal Arsenal |
| AA-Kratos P282 | Foundational Kratonic Arts |
| AA-Kratos P302 | Elektromagneton Classification |
| AA-Kratos P303 | Nomothete Quadrivium |
