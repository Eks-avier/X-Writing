...
# Classification
category: Abilities
topic: Atomic Stride Development (Narrative)
...
The Atomic Stride, or Stride as I, [[Godzilla, the King of the Monsters|Godric Nordson]], simply call it, is a developing ability under my *Domination of Energy* aimed to make me more mobile.
...
3. The third is due to my sudden arrival at point B, if I land on it.
...
This is a consequence of either over-shooting or under-shooting. If I reduce the charge going into my legs, I travel less; if I increase the charge too much—[[Atomic Stride#Issue 2|Issue #2]] is triggered.
...
|------|-------|------------------------------|
| **Atomic Amplification** | — | The master technique combining all three Edicts of Coating |
| **Fortification** | Stereosis (στερέωσις) | The leg enhancement described in Step 2 |
| **Personal Coating** | Epichrisis (ἐπίχρισις) | The foundational art of sheathing body/objects with Aura |

> **Note:** "Domination of Energy" as referenced here reflects Battra's initial classification. The formal Kratonic framework identifies Atomic Stride as an application of **Fortification** (internal leg enhancement) combined with controlled energy projection.
