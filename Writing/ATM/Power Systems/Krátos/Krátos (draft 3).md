...
**Krator Aura**:
- Dual-layer system (Royal Presence + Sovereign Domain)
- Passive emanation without conscious effort
- Territorial suppression of other power systems
...
**Application**:
- Koinon: Must learn to apply Neutralization to their Aura
- Krator: Passive application; can train for selective control

**Effects**: Range from unconsciousness to complete will nullification
