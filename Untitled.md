	...
	- This is the process of imbuing Neutralization on an attack imbued with Penetration, essentially layering the former over the other.
		...
		- Because Krátos has no mediating factor, this gives them a nifty tool to counteract both Psionics and Magics.
			- The other two systems have ways to protect themselves against Piercing, as it only deals with *innate* resistances and immunities.
				- Gaining defensive enhancements via psionic and magical abilities enables reliable protection against a Kraton's assault.
			- To answer this, Kratons have the ability to *inject* their willpower into the psionic/magical structures, causing them to either **rupture** or **collapse**.
			- When a Kraton does *Injection*, his willpower becomes a foreign agent in magical/psionic structure, destabilizing the careful balance within.
			...
			- For example, I have a flame sorcerer against a Koinon Pyroton.
				...
				- This concept applies equally to telekinetic barriers.
			- Some caveats exist for Injection.
				- It only works for *physical* structures.
				- 
