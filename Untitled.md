			...
			- For example, I have a flame sorcerer against a Koinon Pyroton.
				...
				- A Pyroton's Penetration has no answer for this, even if both combatants share an element.
					...
					- The fire generated by the sorcerer for his shield spell *is* a complex structure made of many moving parts.
						- The shield spell either collapses and dispels, or the Kraton is now able to blow a hole in the protective structure.
				- This concept applies equally to telekinetic barriers and any other psionic technique.
			- Injection is largely applicable only to *tangible* structures.
