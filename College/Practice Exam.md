...
### Problem 3: Complex DC Circuit Analysis (14 points)
...
A potential difference of $24.0 \, \text{V}$ is applied between points a and d.

**Find:**
1. The equivalent resistance between points a and d
2. The total current from the battery
3. The current through $R_3$
4. The power dissipated in $R_2$

**Equations:** Series: $R_{eq} = R_1 + R_2 + ...$, Parallel: $\frac{1}{R_{eq}} = \frac{1}{R_1} + \frac{1}{R_2} + ...$
